...
<body>
	<center>
		<h3>
				<br><font color="blue">Update Student Details</font><br><br>
		</h3>
	</center>
	<table class="table table-bordered table-hover">
		...
		<tr class="table-primary">
			<form action="updatestudentnow.jsp">
				...
				<td><input type="text" value=<%=e.getName()%> name="name" style="height:30px;width:300px;"></input>
				</td>
				<td><input type="text" value=<%=e.getPassword()%> name="pass" style="height:30px;width:300px;"></input>
				</td>
				<td><input type="submit" value="update" class="btn btn-outline-danger"></td>
		...
		<tr>
			<th colspan="2"><center>
					<input type="button" class="btn btn-outline-success"
						value="Add Student" onclick="location.href='AddStudent.jsp'">
				</center></th>
