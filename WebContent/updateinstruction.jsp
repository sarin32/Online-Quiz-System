...
<body>
	<center>
		<h3>
				<br><font color="blue">Update Instructions</font><br><br>
		</h3>
	</center>
		...
		<tr class="table-primary">
			<form action="updateinstructionnow.jsp">
				<input type="hidden" value="<%=e.getInstruction()%>" type="text"
					name="instoriginal">
				<td><%=i++%></td>
				<td><textarea name="instmodified" style="height:100px;width:500px;"><%=e.getInstruction()%></textarea></td>
		...
		<tr>
			<th colspan="1" rowspan="2"><center>
					<input type="button" class="btn btn-outline-success"
						...
						onclick="location.href='AddInstruction.jsp'">
				</center></th>
