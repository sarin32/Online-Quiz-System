...
<%@page import="oes.model.ResultsDao"%>
...
<body>
	...
	%><div height="100" width=100% style="background-color: yellow">
		<pre>
		
			<h1><center><font color="green">Results</font></center></h1>
		</pre>
	</div>
	<%
		...
		<thead>
			<tr class="table-warning">
				<th colspan="3" scope="col"><center>
						<pre>
							<h4>====== Name:<%=session.getAttribute("name")%> ====== Username:<%=session.getAttribute("username")%> ====== </h4></pre>
					</center></th>
			</tr>
		</thead>
		<tbody>
	...
	<center>
		<input onclick="location.href='StudentInstructions.jsp'"
