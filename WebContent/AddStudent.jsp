...
<body>
	<center>
		<h3>
			<br> <font color="blue">Add Student</font><br>
			<br>
		</h3>
	</center>
...
Name:         <input type="text" name="name" style="height:30px;width:700px;">

Username:     <input type="text" name="uname" style="height:30px;width:700px;">

Password:     <input type="text" name="pass" style="height:30px;width:700px;">
